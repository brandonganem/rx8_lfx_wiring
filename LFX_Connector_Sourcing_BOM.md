# GM LFX Engine Harness Connector Sourcing BOM

This Bill of Materials (BOM) lists the specific connector housings and pigtails required for the GM LFX 3.6L V6 engine harness.

**Preferred Vendor:** [Ballenger Motorsports](https://www.bmotorsports.com) (Connector Kits preferred over pigtails).

| Component | Connector Series | Housing P/N (GM/Aptiv/Bosch) | Ballenger Kit Link | Notes |
| :--- | :--- | :--- | :--- | :--- |
| **Ignition Coil** (x6) | Delphi GT 150 4-Way | **13585860** | [CONN-75636](https://www.bmotorsports.com/shop/advanced_search_result.php?keywords=CONN-75636) | 4-way GT 150 for GM truck ignition coils |
...
## Sourcing Tips
*   **Ballenger Motorsports:** The links above take you directly to the connector kits which include the housing, terminals, and seals. This is generally cheaper and cleaner than buying pigtails.
*   **Mouser / DigiKey:** You can search these sites using the "Housing P/N" if you need to buy in bulk (50+ units), but you must order terminals and seals separately.
*   **RockAuto / Amazon:** Use the ACDelco Pigtail P/N (e.g., PT2345) if you specifically need a pre-wired pigtail for a quick repair.
